...
public class Sample06 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("1동 1층 3세대 : %d\t", household[0][0][2]);
		
		System.out.printf("1동 2층 1세대 : %d\t", household[0][1][0]);
		System.out.printf("1동 2층 1세대 : %d\t", household[0][1][1]);
		System.out.printf("1동 2층 1세대 : %d\t", household[0][1][2]);
		
		System.out.printf("1동 3층 1세대 : %d\t", household[0][2][0]);
